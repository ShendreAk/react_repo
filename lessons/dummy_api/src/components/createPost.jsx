...
const CreatePost = () => {
  ...
  const handleForm = (event) => {
    ...
    const post = { userid, title, body, reactions, views, tags }
    addPost(post);
  }
  return (
    <form className="createPost" onSubmit={handleForm}>
      ...
      <div className="mb-3">
        ...
        <input type="text" ref={viewsElement} className="form-control" id="reactions" placeholder="How many people reacted to this post" />
      </div>
